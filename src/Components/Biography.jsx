  ...
  <section className="biography">
    <div className='containerProfile'>
      ...
      <p className='contentProfile'>
        ...
        <br />
        E hoje, além de aumentar cada dia mais o faturamento da minha Agência de Viagem, eu ajudo pessoas como Você a fazer o que eu faço! <br />
        <br />
        Já são dezenas de mentorados que usam a minha Metodologia para venderem pacotes aéreos aumentando assim as suas vendas, e agora o próximo a ter acesso a isso será você. <br />
        <br />
      </p>
